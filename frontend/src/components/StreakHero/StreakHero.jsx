...
export default function StreakHero({ streakStatus, actionLoading, onTriggerClaimFlow, onCountdownComplete }) {
  ...
  useEffect(() => {
    ...
    if (streakStatus.alreadyClaimedToday && nextTimestamp) {
      ...
      const calcRemaining = () => {
        ...
        // When visual timer hits zero: do not assume claim is allowed. Request fresh status from backend!
      ...
      <div className="container">
        <div className={styles.heroCard}>
          <div className="row align-items-center g-4">
            {/* Left Column: Heading, Status, CTA */}
